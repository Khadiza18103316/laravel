...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{url('backend/bower_components/morris.js/morris.cs')}}">
  <!-- jvectormap -->
...
<!-- Morris.js charts -->
<script src="{{url('backend/bower_components/raphael/raphael.min.js')}}"></script>
...
<script src="{{url('backend/bower_components/bootstrap-daterangepicker/daterangepicker.js')}}"></script>
<!-- datepicker -->
